...
public:
  ...
  explicit LiteralNode(std::string_view data_text, size_t pos): ExpressionNode(pos), value(nlohmann::json::parse(data_text)) {}
...
public:
  ...
  explicit DataNode(std::string_view ptr_name, size_t pos): ExpressionNode(pos), name(ptr_name), ptr(nlohmann::json::json_pointer(convert_dot_to_ptr(ptr_name))) {}
